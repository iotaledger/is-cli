...
export declare class Identity extends Base {
     ...
     * @returns
     */
    create(username: string, claim: Claim): Promise<IdentityJsonUpdate>;
    /**
     ...
     * @returns
     */
    find(identityId: string): Promise<User>;
    /**
     ...
     * @returns
     */
    remove(identityId: string, revokeCredentials?: boolean): Promise<null>;
    /**
     * Get the latest version of an identity document (DID) from the IOTA Tangle.
     * @param identityId
     * @returns
     */
    latestDocument(identityId: string): Promise<LatestIdentityJson>;
    /**
     ...
     * @returns
     */
    addTrustedAuthority(trustedAuthority: TrustedRootBody): Promise<null>;
    /**
     ...
     * @returns
     */
    createCredential(initiatorVC: VerifiableCredentialInternal, targetDid: string, claim: any): Promise<VerifiableCredentialJson>;
    /**
