...
class Subscription extends base_1.Base {
    ...
    findAll(channelAddress, isAuthorized) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.get(`subscriptions/${channelAddress}`, params, base_1.Base.jwtToken);
        });
    }
    /**
    ...
    find(channelAddress, identityId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.get(`subscriptions/${channelAddress}/${identityId}`, {}, base_1.Base.jwtToken);
        });
    }
    /**
    ...
    request(channelAddress, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.post(`subscriptions/request/${channelAddress}`, options, base_1.Base.jwtToken);
        });
    }
    /**
    ...
    authorize(channelAddress, subscriptionIdentifier) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.post(`subscriptions/authorize/${channelAddress}`, subscriptionIdentifier, base_1.Base.jwtToken);
        });
    }
    /**
    ...
    revoke(channelAddress, subscriptionIdentifier) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.post(`subscriptions/revoke/${channelAddress}`, subscriptionIdentifier, base_1.Base.jwtToken);
        });
    }
    /**
    ...
    add(channelAddress, identityId, subscription) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.post(`subscriptions/${channelAddress}/${identityId}`, subscription, base_1.Base.jwtToken);
        });
    }
    /**
    ...
    update(channelAddress, identityId, updatedSubscription) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.put(`subscriptions/${channelAddress}/${identityId}`, updatedSubscription, base_1.Base.jwtToken);
        });
    }
    /**
    ...
    remove(channelAddress, identityId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.delete(`subscriptions/${channelAddress}/${identityId}`, {}, base_1.Base.jwtToken);
        });
    }
}
