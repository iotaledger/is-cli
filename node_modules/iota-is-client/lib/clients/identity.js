...
class Identity extends base_1.Base {
    ...
    search(username) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.get('identities/search', { username }, this.jwtToken);
        });
    }
    /**
    ...
    find(identityId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.get(`identities/identity/${identityId}`, {}, this.jwtToken);
        });
    }
    /**
     ...
     * @returns
     */
    remove(identityId, revokeCredentials = false) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.delete(`identities/identity/${identityId}`, { 'revoke-credentials': revokeCredentials }, this.jwtToken);
        });
    }
    /**
     ...
     * @returns
     */
    latestDocument(identityId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.get(`verification/latest-document/${identityId}`);
        });
    }
    /**
     ...
     * @returns
     */
    addTrustedAuthority(trustedAuthority) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.post('verification/trusted-roots', trustedAuthority, this.jwtToken);
        });
    }
    /**
    ...
    removeTrustedAuthority(trustedAuthorityId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.delete(`verification/trusted-roots/${trustedAuthorityId}`, {}, this.jwtToken);
        });
    }
    /**
     ...
     * @returns
     */
    createCredential(initiatorVC, targetDid, claim) {
        return __awaiter(this, void 0, void 0, function* () {
            let body = {
                subject: {
                    identityId: targetDid,
                    credentialType: 'VerifiedIdentityCredential',
                    claim: Object.assign({ type: 'Person' }, claim),
                },
                initiatorVC: initiatorVC,
            };
            return yield this.post('verification/create-credential', body, this.jwtToken);
        });
    }
    /**
    ...
    revokeCredential(credential) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.post('verification/revoke-credential', credential, this.jwtToken);
        });
    }
}
