...
class Channel extends base_1.Base {
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.post('channels/create', data, this.jwtToken);
        });
    }
    /**
    ...
    write(address, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.post(`channels/logs/${address}`, data, this.jwtToken);
        });
    }
    /**
    ...
    read(address, limit, index, asc = true, startDate, endDate) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.get(`channels/logs/${address}`, { limit, index, asc, 'start-date': startDate, 'end-date': endDate }, this.jwtToken);
        });
    }
    /**
    ...
    validate(address, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.post(`channels/validate/${address}`, data, this.jwtToken);
        });
    }
    /**
    ...
    reimport(address, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.post(`re-import/${address}`, data, this.jwtToken);
        });
    }
    /**
    ...
    add(channel) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.post('channel-info/channel', channel, this.jwtToken);
        });
    }
    /**
    ...
    update(channel) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.put('channel-info/channel', channel, this.jwtToken);
        });
    }
    /**
    ...
    remove(address) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.delete(`channel-info/channel/${address}`, {}, this.jwtToken);
        });
    }
}
