...
export function documenthistory_toJSON(a: number): number;
export function documenthistory_fromJSON(a: number): number;
...
export function integrationchainhistory_toJSON(a: number): number;
export function integrationchainhistory_fromJSON(a: number): number;
export function diffchainhistory_chainData(a: number): number;
export function diffchainhistory_spam(a: number): number;
export function diffchainhistory_toJSON(a: number): number;
export function diffchainhistory_fromJSON(a: number): number;
export function __wbg_client_free(a: number): void;
export function client_new(): number;
export function client_fromConfig(a: number): number;
export function client_fromNetwork(a: number): number;
export function client_network(a: number): number;
export function client_publishDocument(a: number, b: number): number;
export function client_publishDiff(a: number, b: number, c: number, d: number): number;
export function client_publishJSON(a: number, b: number, c: number, d: number): number;
export function client_resolve(a: number, b: number, c: number): number;
export function client_resolveHistory(a: number, b: number, c: number): number;
export function client_resolveDiffHistory(a: number, b: number): number;
export function client_checkCredential(a: number, b: number, c: number): number;
export function client_checkPresentation(a: number, b: number, c: number): number;
...
export function timestamp_parse(a: number, b: number): number;
...
export function document_new(a: number, b: number, c: number, d: number, e: number): number;
...
export function document_set_message_id(a: number, b: number, c: number): void;
export function document_previous_message_id(a: number, b: number): void;
export function document_set_previous_message_id(a: number, b: number, c: number): void;
...
export function document_merge(a: number, b: number): void;
...
export function config_fromNetwork(a: number): number;
export function config_setNetwork(a: number, b: number): void;
export function config_setNode(a: number, b: number, c: number): void;
export function config_setPrimaryNode(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): void;
export function config_setPrimaryPoWNode(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): void;
export function config_setPermanode(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): void;
export function config_setNodeAuth(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): void;
export function config_setNodeSyncInterval(a: number, b: number): void;
export function config_setNodeSyncDisabled(a: number): void;
export function config_setQuorum(a: number, b: number): void;
export function config_setQuorumSize(a: number, b: number): void;
export function config_setQuorumThreshold(a: number, b: number): void;
export function config_setLocalPoW(a: number, b: number): void;
export function config_setTipsInterval(a: number, b: number): void;
export function config_setRequestTimeout(a: number, b: number): void;
...
export function network_try_from_name(a: number, b: number): number;
...
export function didurl_parse(a: number, b: number): number;
...
export function didurl_set_fragment(a: number, b: number, c: number): void;
export function didurl_path(a: number, b: number): void;
export function didurl_set_path(a: number, b: number, c: number): void;
export function didurl_query(a: number, b: number): void;
export function didurl_set_query(a: number, b: number, c: number): void;
export function didurl_join(a: number, b: number, c: number): number;
...
export function documentdiff_set_message_id(a: number, b: number, c: number): void;
export function documentdiff_previous_message_id(a: number, b: number): void;
export function documentdiff_set_previous_message_id(a: number, b: number, c: number): void;
export function documentdiff_proof(a: number): number;
export function documentdiff_merge(a: number, b: number): number;
export function __wbg_did_free(a: number): void;
export function did_new(a: number, b: number, c: number): number;
export function did_fromBase58(a: number, b: number, c: number, d: number): number;
export function did_parse(a: number, b: number): number;
export function did_network(a: number): number;
export function did_network_name(a: number, b: number): void;
export function did_tag(a: number, b: number): void;
export function did_join(a: number, b: number, c: number): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hca1c949258eb7ac8(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h083f451165792d8f(a: number, b: number, c: number, d: number): void;
