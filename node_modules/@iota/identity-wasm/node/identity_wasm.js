...
function __wbg_adapter_32(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hca1c949258eb7ac8(arg0, arg1, addHeapObject(arg2));
}
...
function __wbg_adapter_263(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h083f451165792d8f(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
class Client {
    ...
    */
    publishDocument(document) {
        try {
            var ret = wasm.client_publishDocument(this.ptr, addBorrowedObject(document));
...
class Document {
    ...
    */
    set messageId(message_id) {
        var ptr0 = passStringToWasm0(message_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.document_set_message_id(this.ptr, ptr0, len0);
    }
    /**
    * @returns {string}
    */
    ...
    */
    set previousMessageId(value) {
        ...
        var len0 = WASM_VECTOR_LEN;
        wasm.document_set_previous_message_id(this.ptr, ptr0, len0);
    }
    /**
    ...
    */
    diff(other, message, key) {
        ...
        return DocumentDiff.__wrap(ret);
    }
    /**
    ...
    */
    merge(diff) {
        _assertClass(diff, DocumentDiff);
        wasm.document_merge(this.ptr, diff.ptr);
    }
    /**
...
class DocumentDiff {
    ...
    */
    set messageId(message_id) {
        var ptr0 = passStringToWasm0(message_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.documentdiff_set_message_id(this.ptr, ptr0, len0);
    }
    /**
    ...
    */
    set previousMessageId(message_id) {
        var ptr0 = passStringToWasm0(message_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.documentdiff_set_previous_message_id(this.ptr, ptr0, len0);
    }
    /**
    ...
    */
    get proof() {
        var ret = wasm.documentdiff_proof(this.ptr);
        return takeObject(ret);
    }
    /**
    ...
    */
    merge(document) {
        _assertClass(document, Document);
        var ret = wasm.documentdiff_merge(this.ptr, document.ptr);
        return Document.__wrap(ret);
    }
}
...
module.exports.__wbindgen_closure_wrapper5144 = function(arg0, arg1, arg2) {
    var ret = makeMutClosure(arg0, arg1, 818, __wbg_adapter_32);
    return addHeapObject(ret);
};
